...
export default function ProducerRequestsPage() {
  return (
    <AuthGuard allowedRoles={["producer"]}>
      <DashboardShell title="Talepler" description="Eski ve yeni request kayıtlarının birleşik görünümü." navItems={producerNavItems}>
