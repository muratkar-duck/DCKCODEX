...
export default function ProducerBrowsePage() {
  return (
    <AuthGuard allowedRoles={["producer"]}>
      <DashboardShell title="Keşfet" description="Senaryoları ve ilanları filtreleyerek görüntüleyin." navItems={producerNavItems}>
