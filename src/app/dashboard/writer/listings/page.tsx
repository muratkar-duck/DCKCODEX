...
export default function WriterListingsPage() {
  return (
    <AuthGuard allowedRoles={["writer"]}>
      <DashboardShell title="Aktif İlanlar" description="v_listings_unified görünümünden veri çekilir." navItems={writerNavItems}>
