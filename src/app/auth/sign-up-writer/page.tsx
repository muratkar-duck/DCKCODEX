  ...
  return (
    <div className="mx-auto w-full max-w-md space-y-6 px-6 py-16">
      <header className="space-y-2 text-center">
        <h1 className="text-2xl font-semibold text-forest-900">Yazar olarak katıl</h1>
        <p className="text-sm text-forest-700">Senaryolarını fiyatlandır, başvuruları takip et.</p>
      </header>
      <form
        onSubmit={handleSubmit(onSubmit)}
        className="space-y-4 rounded-3xl border border-forest-100 bg-white/90 p-6 shadow-sm"
        data-test-id="sign-up-writer-form"
      >
